...
import {MinusCircleOutlined, PlusOutlined, UserOutlined, TeamOutlined,UsergroupAddOutlined, ScheduleOutlined, CarryOutOutlined, NotificationOutlined } from '@ant-design/icons';
                ...
                <Header className="header">
                    <Space size={330}>
                        ...
                        <Menu theme="dark" mode="horizontal" defaultSelectedKeys={['3']}>
                            ...
                            <Menu.Item key="4"><Link to="/SiderFour">page 4</Link></Menu.Item>
                        </Menu>
                    ...
                    <Sider width={200} className="site-layout-background">
                        ...
                        >
                            <SubMenu key="sub1" icon={<UserOutlined />} title="个人信息">
                                ...
                                <Menu.Item key="3"><Link to="/SiderThree">最近通知</Link></Menu.Item>
                                <Modal
                                    title="Notification"
                        ...
                        <Sider width={150} className="Quick-functions">
                            ...
                            >
                                <SubMenu key="sub1" icon={<UsergroupAddOutlined />} title="Add">
                                    <div align='middle'>
                                        <Button type='text' onClick={this.showModal6}>创建群组</Button>
                                        <Modal
                                            title="创建群组"
                                        ...
                                        >
                                            <Form name="dynamic_form_item" onFinish={onFinish4} layout="vertical" hideRequiredMark>
                                                <Row gutter={16}>
                                                    <Col span={12}>
                                                        <Form.Item
                                                            name="group name"
                                                                                    ...
                                                                                    rules={[
                                                                                        {
                                                                                            required: true,
                                                                                            whitespace: true,
                                                                                            message: "Please input member's userID.",
                                                                                        },
                                                                                    ]}
                                                                                    noStyle
                                                                                >

                                                                                    <Input placeholder=" UserID" style={{ width: '80%' }} />
                                                                                </Form.Item>
                                                                                <MinusCircleOutlined
